...
- Условное ограничение - выбрав операцию сложения, считается, что оба введенных числа являются положительными, то есть больше, либо равные нулю. Для сложения отрицательного числа с положительным, либо положительного с отрицательным используется операция "вычитание", для которой как раз таки не важен порядок ввода чисел.
...
- Полагаем, что оба числа либо являются отрицательными, либо положительными, потому что иначе будет просто вызвана функция сложения и выведен ответ со знаком '-' или '+'.
