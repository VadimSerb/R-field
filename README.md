...
- Ограничение является условным, потому что при желании можно добавить необходимую проверку на знак, чтобы можно было складывать положительно число с отрицательным, либо отрицательное с отрицательным при выборе операции "сложение".
