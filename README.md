...
- Условное ограничение - выбрав операцию сложения, считаем, что оба введенных числа являются положительными, то есть больше, либо равные нулю. Для сложения отрицательного числа с положительным, либо положительного с отрицательным используется операция "вычитание", для которой как раз таки не важен порядок ввода чисел.
