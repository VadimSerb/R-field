...
У обоих ответов совпадают с исходным числом только 15 разрядов Таким образом, точно восстановить число ни одной из программ не получилось. Тест можно считать пройденным.
