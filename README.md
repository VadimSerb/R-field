...
В таком представлении очень просто реализовать сложение отдельно целых частей и отдельно дробных частей двух чисел, предусмотрев возможное переполнение первого разряда дробной части прибавкой единицы к результату сложения целых частей. Остается только вывести по отдельности целую и дробную части, разделив их выводом символа ','.
