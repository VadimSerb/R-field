...
- Условное ограничение - выбрав операцию сложения, считаем, что оба введенных числа являются либо оба положительными, либо оба отрицательными. Для сложения отрицательного числа с положительным, либо положительного с отрицательным используется операция "вычитание", для которой как раз таки не важен порядок ввода чисел.
