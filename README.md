...
- III. В случае, когда выбрана операция умножения или деления, ```FillingValues``` не будет вызывать ни ```ReverseNumber```, ни ```FillingFraction```, а дробная часть отделяться от целой не будет. Наоборот, будет вызвана функция для "склеивания" целой и дробной части путем удаления запятой и сдвига на 1 символ. 
